...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <a href="tambah.php" class="btn btn-primary">Jenis Barang Baru</a>
        ...
        if(mysqli_num_rows($query)){
            ...
            while($result=mysqli_fetch_assoc($query)){
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit.jenis.php?id_jenis=<?php echo $result['id_jenis']?>" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i>Edit</a>
